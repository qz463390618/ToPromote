...
<div id="content">
    <div class="content_head">
        ...
        <ul class="breadcrumb">
            <li>推广管理</li>
            <li class="active"><a href="">修改特征</a></li>
        </ul>
    </div>
    ...
    <div class="addForm">
        <form action="{{url('/admin/message/editMessage')}}" method="post" class="form-horizontal" style="width: 30%;margin-left: 18%;">
                ...
                <div class="one_group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 60%;">
                            <input type="text" name="url" class="form-control" id="inputUrl3" placeholder="网址" value="<?= old('url') ?old('url') : $urlInfo['url']?>">
                            @if(count($errors)>0)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 60%;">
                            <input type="text" name="message" class="form-control" id="inputMessage3" placeholder="对应网页信息" value="<?= old('message') ?old('message') : $urlInfo['message']?>">
                            @if(count($errors)>0)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 60%;">
                            <select class="form-control input-sm" name="SE">
                                <option> </option>
                                <option <?= $urlInfo['url_se'] == '360' ? 'selected':'' ?> >360</option>
                                <option <?= $urlInfo['url_se'] == '搜狗' ? 'selected':'' ?>>搜狗</option>
                                <option <?= $urlInfo['url_se'] == '神马' ? 'selected':'' ?>>神马</option>
                            </select>
            ...
            <button type="submit" class="btn btn-default" style="margin-left: 36%;">修改</button>
        </form>
    </div>
