...
<div class="banner2">
    <div class="qrbox1">
        ...
        <!-- 小徐 -->
        <img src="http://finance.zengwf.com/wx_%E5%B0%8F%E5%BE%9003.png" width="200px">
    </div>
</div>
<div class="banner3">
    <div class="wxhboxWrap">
        <div class="wxhbox">
            <p class="qq-groupNo" onclick="ga('send','event', createUrlStr(),'复制微信号')">ai503055</p>
        </div>
    </div>
</div>
<div class="wrap">
                ...
                <div class="form-content">
                    <div class="form-group">
                        <div class="form-input">
                            <img src="http://finance.zengwf.com/wx_%E5%B0%8F%E5%BE%9003.png" width="200px" style="margin-left:50px;">
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
