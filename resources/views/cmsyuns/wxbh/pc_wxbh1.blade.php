...
<head>
    ...
    <link rel="stylesheet" href="{{url('css/wxbh/style_2.css')}}">
...
<div class="banner2">
    <div class="qrbox1">
        ...
        <!-- 助理小张 -->
        <img src="http://finance.zengwf.com/wx_%E5%8A%A9%E7%90%86%E5%B0%8F%E5%BC%A001.png" width="200px">
    </div>
</div>
<div class="banner3">
    <div class="wxhboxWrap">
        <div class="wxhbox">
            <p class="qq-groupNo" onclick="ga('send','event', createUrlStr(),'复制微信号')">xiaosheng44452</p>
        </div>
    </div>
</div>
<div class="wrap">
...
<!-- <div class="wrap">
    <div class="pic3">
        <div class="qrbox1">
            <img src="http://p09rldi4k.bkt.clouddn.com/image/wxbh/er2.jpg" width="200px">
        </div>
...
<div class="layui-layer layui-layer-page layer-form layer-anim" id="layui-layer3" type="page" showtime="0"time="3" contype="object" style="display: none;">
    <div id="" class="layui-layer-content">
        <div class="modal-form layui-layer-wrap" id="modal-form" style="display: block;">
            <p style="font-size: 40px;color:#41A5DD ;text-align: center;padding-top: 40px;">请扫描二维码</p>
            <!-- <p style="font-weight:normal; color:#999; font-family:宋体; font-size:14px;text-align: center;padding-top:10px;">（每天早九点推送三只绩优股！）</p> -->
                ...
                <div class="form-content">
                    <div class="form-group">
                        <div class="form-input">
                            <img src="http://finance.zengwf.com/wx_%E5%8A%A9%E7%90%86%E5%B0%8F%E5%BC%A001.png" width="200px" style="margin-left:50px;">
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
