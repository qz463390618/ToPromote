<?php
Route::domain('vip.yunzhiwen.top')->group(function () {
	//微信论坛推广微信1
	...
	//微信爆好股
    Route::get('wxbh1',function(){
        return view('cmsyuns.wxbh.pc_wxbh1');
    });
    Route::get('wxbh2',function(){
        return view('cmsyuns.wxbh.pc_wxbh2');
    });
    Route::get('wxbh3',function(){
        return view('cmsyuns.wxbh.pc_wxbh3');
    });
    Route::get('wxbh4',function(){
        return view('cmsyuns.wxbh.pc_wxbh4');
    });
    Route::get('wxbh5',function(){
        return view('cmsyuns.wxbh.pc_wxbh5');
    });
