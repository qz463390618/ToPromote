        ...
        $.fn.dateLay=function(o){
            ...
            var global={
                ...
                getOptions:function(){
                    ...
                    html.push('<span class="layui-btn layui-btn-middle fr" id="timeOk"><label class="ui-button-text" style="line-height: 34px;">确定</label></span>');
                    html.push('<span class="layui-btn layui-btn-primary layui-btn-middle fr mr5" id="timeNo"><label class="ui-button-text" style="line-height: 34px;">清空</label></span>');
                    html.push('</div>');
                    html.push('</div>');
                    // 插入到文档流中
