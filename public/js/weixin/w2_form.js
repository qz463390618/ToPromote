        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                }else if(data == 200)
                {
                    ...
                    $(Form).css('display','none');
                    //创建微信号元素
                    $(Form).after('<div class="weixin"><p><img src="http://img.zengwf.com/images/wxh/01.jpg" alt="" width="200"></p><p>如安装过程中遇到问题，请扫描二维码添加您的专属客服或添加微信号<span style="color:red">HX201805</span style></p><p style="margin-top: 1rem;"><a href="javascript:void(0)" class="wx_colse">关闭</a></p></div>');
                    //$(mask).css('display','none');
                    //获取关闭微信按钮
